...
class PostHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => di.sl<GetUserProfileByIdCubit>()..loadUserProfileById(post.authorId),
      child: Builder(
        builder: (localContext) {
          ...
          final otherProfileState = localContext.watch<GetUserProfileByIdCubit>().state;

          String authorName = post.authorName ?? "User";
          String? authorImage = post.authorImage;

          if (otherProfileState is GetUserProfileByIdLoaded) {
